...
func TestTransaction_MarshalBson_UnMarshal(t *testing.T) {
	response, err := testData.MarshalBson()
	if err != nil {
		t.Errorf("Could not marshall Bson")
	}
	fmt.Println(response)

	testData.unMarshalBson(response)
